...
public enum Stat {
	...
	ENTITIES_SECTION(true, 1.0E-6D),
		WEATHER_EFFECTS(true, 1.0E-6D),
		ENTITIES_REMOVE(true, 1.0E-6D),
		ENTITIES_REGULAR(true, 1.0E-6D),
			ENTITY_UPDATE(false, 1.0E-6D),
		ENTITIES_TILE(true, 1.0E-6D),
			TILE_ENTITY_UPDATE(false, 1.0E-6D),
		ENTITIES_TILEPENDING(true, 1.0E-6D),
