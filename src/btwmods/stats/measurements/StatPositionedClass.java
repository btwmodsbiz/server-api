...
public class StatPositionedClass extends StatPositioned {
	...
	public StatPositionedClass(World world, Entity entity) {
		this(Stat.ENTITY_UPDATE, world, entity.posX, entity.posY, entity.posZ, entity.getClass(), Util.getEntityName(entity));
	}
	
	public StatPositionedClass(World world, EntityTrackerEntry trackerEntry) {
		this(Stat.UPDATE_TRACKED_ENTITY_PLAYER_LIST, world, trackerEntry.trackedEntity.posX, trackerEntry.trackedEntity.posY, trackerEntry.trackedEntity.posZ, trackerEntry.trackedEntity.getClass(), Util.getEntityName(trackerEntry.trackedEntity));
	}
}
