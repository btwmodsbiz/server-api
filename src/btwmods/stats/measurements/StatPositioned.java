...
public class StatPositioned extends StatChunk {
	...
	public StatPositioned(Stat identifier, World world, int x, int y, int z) {
	...
	public StatPositioned(Stat identifier, World world, double xDouble, double yDouble, double zDouble) {
	...
	private StatPositioned(Stat identifier, World world, int x, int y, int z, double xDouble, double yDouble, double zDouble) {
		super(identifier, world, x >> 4, y >> 4);
		this.x = x;
		this.y = y;
		this.z = z;
